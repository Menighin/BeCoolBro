package com.onsoftwares.becoolbro.activities;
...
import com.onsoftwares.becoolbro.fragments.BreathFragment;
import com.onsoftwares.becoolbro.fragments.ZenImagesFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.zen_messages_menu) {
            ft.replace(R.id.main_fragment_holder, new ZenImagesFragment()).commit();
        } else if (id == R.id.zen_breath_menu) {
